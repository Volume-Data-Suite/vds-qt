...
#include "expandable_section_widget.h"

ExpandableSectionWidget::ExpandableSectionWidget(const QString& title, const int animationDuration, QWidget* parent)
...
void ExpandableSectionWidget::setContentLayout(QLayout& contentLayout) {
